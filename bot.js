   ...
   client.on("message", message => {
    if (message.content === "-help--1") {
     const embed = new Discord.RichEmbed() 
         ...
         .setColor("#00FF00")
         .setDescription(`**  السيرفر الرسمي للبوت :  :dove:  https://discord.gg/6USWQMa :scroll: **`)
...
if (message.author.id !== '350947930670104577') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
...
client.users.get("350947930670104577").send(
    "\n" + "**" + "● السيرفر :" + "**" +
    "\n" + "**" + "» " + message.guild.name + "**" +
    "\n" + "**" + " ● المرسل : " + "**" +
    "\n" + "**" + "» " + message.author.tag + "**" +
...
const sWlc = {}
const premium = ['350947930670104577', '', '', '']
client.on('message', message => {
var prefix = "-";
...
client.config("NTEzNDIzMzg3NDIzNDA4MTI5.DySOPg.9sq3Xt_9X5NOCW-NU8guDYonYcg");
